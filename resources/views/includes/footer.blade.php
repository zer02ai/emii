            ...
            <div class="row brand-active">
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="{{url('')}}/assets/img/brand/b-logo1.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="{{url('')}}/assets/img/brand/b-logo2.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="{{url('')}}/assets/img/brand/b-logo3.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="{{url('')}}/assets/img/brand/b-logo4.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="{{url('')}}/assets/img/brand/b-logo5.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
...
<!-- main-area-end -->
<!-- footer -->
<footer class="footer-bg footer-p pt-90" style="background-color: #125875; background-image: url({{url('')}}/assets/img/bg/footer-bg.png);">
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="footer-widget mb-30">
            ...
            <div class="recent-blog-footer">
              <ul>
                <li>
                  <div class="thum"> <img src="{{url('')}}/assets/img/blog/s-blogimg-01.png" alt="img"></div>
                ...
                <li>
                  <div class="thum"> <img src="{{url('')}}/assets/img/blog/s-blogimg-02.png" alt="img"></div>
                  <div class="text"> <a href="blog-details.html">Nothing impossble to need hard work</a>
                    <span>7 March, 2020</span>
                  </div>
                </li>
  ...
  <div class="copyright-wrap">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="copy-text">
            <a href="index-2.html"><img src="{{url('')}}/assets/img/logo/f_logo.png" alt="img"></a>
          </div>
        </div>
