                ...
                <div class="tab-pane" id="side2">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/2.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/2.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/11.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/11.jpg&quot;) center center;"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/10.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/10.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/13.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/13.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/12.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/12.jpg&quot;) center center;"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/15.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/15.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/4.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/4.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/7.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/7.jpg&quot;) center center;"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/9.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/9.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/2.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/2.jpg&quot;) center center;"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Addie Minstra</div>
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/14.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/14.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/11.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/11.jpg&quot;) center center;"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{  url('') }}/assets/admin/images/users/4.jpg" style="background: url(&quot;{{  url('') }}/assets/admin/images/users/4.jpg&quot;) center center;"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Cherry Blossom</div>
