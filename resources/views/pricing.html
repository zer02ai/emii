...
<!-- Mirrored from htmldemo.zcubethemes.com/qeducato/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Jun 2023 15:35:21 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <main>
           ...
           <!-- breadcrumb-area -->
            ...
            <!-- breadcrumb-area-end -->   
			<!-- pricing-area -->
            <section id="pricing" class="pricing-area pt-150 pb-60 fix p-relative">                
                <div class="container"> 
                   <div class="row">
                          ...
                          <div class="pricing-box pricing-box2 mb-60">
                                    <div class="pricing-head text-center">  
                                        ...
                                        <div class="price-count">
                                            <h2>$150 <strong>/ Per Month Fee</strong></h2>
                                        </div> 
                                    ...
                                    <div class="pricing-btn">
                                       <a href="contact.html" class="btn ss-btn">Join Now <i class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                             <div class="pricing-box pricing-box2 active mb-60">
                                   <div class="pricing-head text-center">  
                                        <h3>Standard</h3>    
                                        <div class="price-count">
                                            <h2>$200 <strong>/ Per Month Fee</strong></h2>
                                        </div> 
                                        <p>Proin vehicula elit a dui rutrum, ac posuere magna auctor.</p>
                                        <hr>
                                    </div>
                         ...
                         <div class="col-lg-4 col-md-6">
                            <div class="pricing-box pricing-box2 mb-60">
                                    <div class="pricing-head text-center">  
                                        <h3>Unlimited</h3>    
                                        <div class="price-count">
                                            <h2>$350 <strong>/ Per Month Fee</strong></h2>
                                        </div> 
                                        <p>Proin vehicula elit a dui rutrum, ac posuere magna auctor.</p>
                                        <hr>
                                    </div>
