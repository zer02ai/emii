...
<!-- Mirrored from htmldemo.zcubethemes.com/qeducato/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Jun 2023 15:17:15 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <main>
           <!-- slider-area -->
            <section id="parallax" class="slider-area slider-two fix p-relative">
               <div class="slider-shape ss-one layer" data-depth="0.10"><img src="img/bg/slider_shape01.png" alt="shape"></div>
				...
				<div class="single-slider slider-bg d-flex align-items-center" style="background: url(img/slider/slider_img02.png) no-repeat; ">
                        <div class="container">
            ...
            <!-- cta-area-end -->	
             <!-- service-area -->
            <section class="service-details-one pt-120 pb-90 p-relative fix"  style="background: url(img/bg/feature-bg.png) no-repeat; background-size: cover;">
                <div class="container">
                    <div class="row">
           ...
           <!-- class area start -->
            <section class="class-area pt-120 pb-120 p-relative fix">
                <div class="animations-06"><img src="img/bg/an-img-11.png" alt="an-img-01"></div>
                <div class="animations-11"><img src="img/bg/an-img-01.png" alt="contact-bg-an-01"></div>
                <div class="animations-12"><img src="img/bg/an-img-12.png" alt="contact-bg-an-01"></div>
                <div class="animations-13"><img src="img/bg/an-img-13.png" alt="contact-bg-an-01"></div>
                <div class="container">
                    <div class="row">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                       <a href="single-courses.html"> <img src="img/class/class-1.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                        <a href="single-courses.html"> <img src="img/class/class-2.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                                <div class="class-content">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                        <a href="single-courses.html"><img src="img/class/class-3.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                                <div class="class-content">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                        <a href="single-courses.html"><img src="img/class/class-4.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                                <div class="class-content">
                                    <h4 class="title"><a href="single-courses.html">Sports Class</a></h4>
                                    <p>Seamlessly visualize quality ellectual capital without superior collaboration and idea.</p>
                                     <ul class="schedule">
                                        <li>
                                            <span>Age:</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                        <a href="single-courses.html"><img src="img/class/class-5.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                                <div class="class-content">
                                    <h4 class="title"><a href="single-courses.html">Knowlage Class</a></h4>
                                    <p>Seamlessly visualize quality ellectual capital without superior collaboration and idea.</p>
                                     <ul class="schedule">
                                        <li>
                                            <span>Age:</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="class-item mb-30 hover-zoomin">
                                <div class="class-img">
                                    <div class="class-img-outer">
                                        <a href="single-courses.html"><img src="img/class/class-6.jpg" alt="class image"></a>
                                    </div>                                    
                                </div>
                                <div class="class-content">
                                    <h4 class="title"><a href="single-courses.html">Science Class</a></h4>
                                    <p>Seamlessly visualize quality ellectual capital without superior collaboration and idea.</p>
                                     <ul class="schedule">
                                        <li>
                                            <span>Age:</span>
            ...
            <section class="event event02 pt-120 pb-90 p-relative fix">
                 <div class="animations-06"><img src="img/bg/an-img-14.png" alt="an-img-01"></div>
                <div class="animations-08"><img src="img/bg/an-img-15.png" alt="contact-bg-an-01"></div>
                <div class="animations-09"><img src="img/bg/an-img-16.png" alt="contact-bg-an-01"></div>
                <div class="container">
                    <div class="row">   
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                            <div class="event-item mb-30 hover-zoomin">
                                <div class="thumb">
                                    <a href="single-event.html"> <img src="img/bg/evn-img-01.png" alt="contact-bg-an-01"></a>
                                </div>
                                <div class="event-content">  
                                    <div class="text">
                                        <div class="icon"><i class="fal fa-calendar-alt"></i></div>
                                        <div class="date"><strong>18</strong> March, 2023</div>
                                        <h3><a href="single-event.html"> Cras faucibus ornare luctus.</a></h3>
                        ...
                        <div class="col-lg-6 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                            <div class="event-item mb-30 hover-zoomin">
                                <div class="thumb">
                                    <a href="single-event.html"><img src="img/bg/evn-img-02.png" alt="contact-bg-an-01"></a>
                                </div>
                                <div class="event-content">  
                                    <div class="text">
                                        <div class="icon"><i class="fal fa-calendar-alt"></i></div>
                        ...
                        <div class="col-lg-6 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                            <div class="event-item mb-30 hover-zoomin">
                                <div class="thumb">
                                    <a href="single-event.html"><img src="img/bg/evn-img-03.png" alt="contact-bg-an-01"></a>
                                </div>
                                <div class="event-content">  
                                    <div class="text">
                                        <div class="icon"><i class="fal fa-calendar-alt"></i></div>
                        ...
                        <div class="col-lg-6 col-md-6  wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                            <div class="event-item mb-30 hover-zoomin">
                                <div class="thumb">
                                    <a href="single-event.html"><img src="img/bg/evn-img-04.png" alt="contact-bg-an-01"></a>
                                </div>
                                <div class="event-content">  
                                    <div class="text">
                                        <div class="icon"><i class="fal fa-calendar-alt"></i></div>
           ...
           <!-- courses-area -->
            ...
            <section class="team-area fix p-relative pt-120 pb-80" style="background: #f7f9ff;">  
                <div class="animations-06"><img src="img/bg/an-img-17.png" alt="an-img-01"></div>
                <div class="animations-09"><img src="img/bg/slider_shape03.png" alt="contact-bg-an-01"></div>
                <div class="container">  
                    <div class="row">   
                        <div class="col-lg-12 p-relative">
                           <div class="section-title center-align mb-50 text-center wow fadeInDown animated" data-animation="fadeInDown" data-delay=".4s">
                               <h5><i class="fal fa-graduation-cap"></i> Our Teacher</h5>
                                <h2>
                                    Our Expert Teacher
                                </h2>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="single-team mb-40" >
                                <div class="team-thumb">
                                    <div class="brd">
                                        <a href="team-single.html"> <img src="img/team/team09.png" alt="img"></a>
            ...
            <!-- team-area-end --> 
            <!-- testimonial-area -->
            <section class="testimonial-area text-center pt-120 pb-120"  style="background: url(img/bg/testimonial-bg.png) no-repeat; background-size: cover;">
                <div class="container">
                    <div class="row justify-content-center">
                         <div class="col-lg-10">
            ...
            <section id="blog" class="blog-area blog-area3 p-relative fix pt-120 pb-90" >
                <div class="animations-06"><img src="img/bg/an-img-18.png" alt="an-img-01"></div>
                <div class="animations-09"><img src="img/bg/an-img-19.png" alt="contact-bg-an-01"></div>
                <div class="container">
                    <div class="row align-items-center"> 
                        <div class="col-lg-12">
                            <div class="section-title center-align mb-50 text-center wow fadeInDown animated" data-animation="fadeInDown" data-delay=".4s">
                            ...
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                ...
                                <div class="blog-content2">   
                                   <div class="b-meta">
                                    ...
                                    <h4><a href="blog-details.html">Full-day kindergarten in Alberta kindergarten saves families.</a></h4>
                                </div>
                            </div>
                        </div>
                         <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="img/blog/inner_b5.jpg" alt="img"></a>
                                     <div class="date-home">
                                        <i class="fal fa-calendar-alt"></i> 24th March 2023
                                    </div>
                                </div>
                                <div class="blog-content2">                                    
                                   ...
                                   <div class="b-meta">
                                    ...
                                    <h4><a href="blog-details.html">Planting Seeds in the Hearts of Preschoolers</a></h4> 
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="img/blog/inner_b6.jpg" alt="img"></a>
                                     <div class="date-home">
                                        <i class="fal fa-calendar-alt"></i> 24th March 2023
                                    </div>
                                </div>
                                <div class="blog-content2">  
                                   <div class="b-meta">
                                    ...
                                    <h4><a href="blog-details.html">Why children need a Healthy Environment thousands</a></h4> 
                                </div>
                            </div>
                        </div>
            ...
            <div class="copyright-wrap">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-4">
                          <div class="copy-text">
                                <a href="index-2.html"><img src="img/logo/f_logo.png" alt="img"></a>   
                            </div>
                        </div>
...
<!-- Mirrored from htmldemo.zcubethemes.com/qeducato/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Jun 2023 15:24:17 GMT -->
</html>